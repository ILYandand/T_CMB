...
if __name__ == "__main__":
    ...
    for i in range(N):
        ...
        errP = getRAND(mean=0.45, sigma=0.35)[0]
        errN = getRAND(mean=0.45, sigma=0.35)[0]

        #shift th kTe for prior and make similar errors
        StrPrior = ['1 ! Num of priors',
                    '1 2 Te {:.1f} {:.1f} {:.1f} ! 2 index of arg Te name of arg'.format(kTe, errP, errN)]
        Name = 'priors\\prior{}.dat'.format(i + 1)
        RW.WRITING(Name=Name, Strin=StrPrior)